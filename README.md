...
[![Build Status](https:/travis-ci.org/eHealthAfrica/angular-eha.cordova.camera.svg?branch=master)](https://magnum.travis-ci.com/eHealthAfrica/angular-eha.cordova.camera)
...
- *dist/angular-eha.cordova.camera.js*
- *dist/angular-eha.cordova.camera.min.js*

Then simply add `eha.cordova.camera` and `eha.cordova.camera.templates` (if you want templates!) as dependencies somewhere in your project that makes sense and you're good to go.

#### A note on wiredep

If you're using wiredep `dist/angular-eha.cordova.camera.template.js` will be injected by default. If you don't want that to happen you'll like want to employ something along the following lines in your `Gruntfile`:
...
wiredep: {
 ...
  options: {
    exclude: [
      'bower_components/angular-eha.cordova.camera/dist/angular-eha.cordova.camera.js'
    ]
  }
  ...
}
...
git clone git@github.com:yourusername/angular-eha.cordova.camera.git
# change into project folder
cd angular-eha.cordova.camera
# Add the upstream as a remote
git remote add upstream  git@github.com:eHealthAfrica/angular-eha.cordova.camera.git
